#run on daily log with current date
#Daily log needs to have information in specific column order
...
#os.chdir('Y:\\documents\\PATH-LABS\\CYTOGENETICS\\CYTOGEN\\Daily Log')
